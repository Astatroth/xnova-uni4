...
--
-- Хост: localhost
-- Время создания: Окт 30 2016 г., 20:24
...
--
-- Структура таблицы `game_alliance_chat`
--

CREATE TABLE IF NOT EXISTS `game_alliance_chat` (
...
--
-- Структура таблицы `game_artifacts`
--
...
(30, '1', 1, 20, 'Контент', 'content', '', ''),
(31, '1', 1, 24, 'Группы', 'groups', '', '');
...
(24, '1', 'content', 'Контент', '1'),
(25, '1', 'groups', 'Группы', '1');
...
--
-- Дамп данных таблицы `game_cms_rights`
--

INSERT INTO `game_cms_rights` (`id`, `module_id`, `group_id`, `right_id`) VALUES
(1, 1, 2, '1'),
(2, 2, 2, '0'),
(3, 3, 2, '1'),
(4, 4, 2, '0'),
...
--
-- Структура таблицы `game_log_sim`
--

CREATE TABLE IF NOT EXISTS `game_log_sim` (
`id` int(11) NOT NULL,
...
`id` int(11) unsigned NOT NULL,
  ...
  `fleet_209` tinyint(2) NOT NULL DEFAULT '0',
  ...
  `fleet_401` tinyint(2) NOT NULL DEFAULT '0',
  `fleet_402` tinyint(2) NOT NULL DEFAULT '0',
  `fleet_403` tinyint(2) NOT NULL DEFAULT '0',
  `fleet_404` tinyint(2) NOT NULL DEFAULT '0',
  `fleet_405` tinyint(2) NOT NULL DEFAULT '0',
  `fleet_406` tinyint(2) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `game_users_quests`
--

CREATE TABLE IF NOT EXISTS `game_users_quests` (
`id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Индексы таблицы `game_alliance_chat`
--
...
--
-- Индексы таблицы `game_artifacts`
--
...
ALTER TABLE `game_fleets`
 ADD PRIMARY KEY (`fleet_id`), ADD KEY `fleet_owner` (`fleet_owner`), ADD KEY `fleet_target_owner` (`fleet_target_owner`), ADD KEY `fleet_time` (`fleet_time`), ADD KEY `fleet_end_system` (`fleet_end_system`), ADD KEY `fleet_start_time` (`fleet_start_time`), ADD KEY `fleet_end_stay` (`fleet_end_stay`), ADD KEY `fleet_end_time` (`fleet_end_time`), ADD KEY `fleet_group` (`fleet_group`);
...
ALTER TABLE `game_hall`
 ADD PRIMARY KEY (`id`), ADD KEY `sab` (`sab`), ADD KEY `time` (`time`);
...
ALTER TABLE `game_messages`
 ADD PRIMARY KEY (`message_id`), ADD KEY `message_owner` (`message_owner`), ADD KEY `message_time` (`message_time`), ADD KEY `message_sender` (`message_sender`), ADD KEY `message_owner_2` (`message_owner`,`message_deleted`);
...
ALTER TABLE `game_planets`
 ADD PRIMARY KEY (`id`), ADD KEY `id_owner` (`id_owner`), ADD KEY `galaxy` (`galaxy`), ADD KEY `system` (`system`), ADD KEY `id_ally` (`id_ally`);
...
ALTER TABLE `game_statpoints`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `id` (`id`), ADD KEY `stat_type` (`stat_type`), ADD KEY `id_owner` (`id_owner`), ADD KEY `total_rank` (`total_rank`), ADD KEY `tech_rank` (`tech_rank`), ADD KEY `defs_rank` (`defs_rank`), ADD KEY `fleet_rank` (`fleet_rank`), ADD KEY `stat_type_2` (`stat_type`,`stat_code`,`stat_hide`);
...
ALTER TABLE `game_users_auth`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `id` (`id`), ADD KEY `user_id` (`user_id`), ADD KEY `external_id` (`external_id`);
...
ALTER TABLE `game_users_info`
 ADD UNIQUE KEY `id` (`id`), ADD KEY `email` (`email`);
...
--
-- Индексы таблицы `game_users_quests`
--
...
--
-- AUTO_INCREMENT для таблицы `game_alliance_chat`
--
ALTER TABLE `game_alliance_chat`
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `game_artifacts`
--
ALTER TABLE `game_artifacts`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `game_log_sim`
--
ALTER TABLE `game_log_sim`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `game_statpoints`
--
ALTER TABLE `game_statpoints`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `game_users_quests`
--
ALTER TABLE `game_users_quests`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
