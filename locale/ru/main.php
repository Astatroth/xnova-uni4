...
(
	'overview' 					=> array('Обзор', '?set=overview', 0),
	'imperium' 					=> array('Империя', '?set=imperium', 0),
	'galaxy' 					=> array('Космос', '?set=galaxy&r=0', 0),
	'fleet' 					=> array('Флот', '?set=fleet', 0),
	'buildings' 				=> array('Постройки', '?set=buildings', 0),
	'buildingsresearch' 		=> array('Наука', '?set=buildings&mode=research', 0),
	'buildingsresearch_fleet' 	=> array('Фабрика', '?set=buildings&mode=research_fleet', 0),
	'buildingsfleet' 			=> array('Верфь', '?set=buildings&mode=fleet', 0),
	'buildingsdefense' 			=> array('Оборона', '?set=buildings&mode=defense', 0),
	'resources' 				=> array('Сырьё', '?set=resources', 0),
	'marchand' 					=> array('Рынок', '?set=marchand', 0),
	'officier' 					=> array('Офицеры', '?set=officier', 0),
	'alliance' 					=> array('Альянс', '?set=alliance', 0),
	'buddy' 					=> array('Друзья', '?set=buddy', 0),
	'notes' 					=> array('Заметки', '?set=notes', 0),
	'records' 					=> array('Рекорды', '?set=records', 0),
	'hall' 						=> array('Зал славы', '?set=hall', 0),
	'log' 						=> array('Логи', '?set=log', 0),
	'calculate' 				=> array('Расчеты', '?set=calculate', 0),
	'admin' 					=> array('Админка', '?set=admin', 1, true),
);
