	...
	<tr>
		<th>
			...
			<? else: ?>
				...
				<form class="noajax" action="" method="POST" target="_blank">
					...
					<input type="hidden" name="SignatureValue" value="<?=md5(SHOP_LOGIN.":".intval($_POST['OutSum']).":".$invid.":".SHOP_MERCHANT.":Shp_UID=".((isset($_POST['userId']) && is_numeric($_POST['userId']) && $_POST['userId'] > 0) ? intval($_POST['userId']) : $userid)) ?>">
