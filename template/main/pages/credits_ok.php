			...
			<ul>
				<li>
					<div class="creditList">
						<span class="number">20</span> <img src="<?=RPATH ?>images/officiers/smalcredts.gif" alt="" align="absmiddle"> <input type="button" onclick="buyCredits(20);" value="Купить">
					</div>
				</li>
				<li>
					<div class="creditList">
						<span class="number">60</span> <img src="<?=RPATH ?>images/officiers/smalcredts.gif" alt="" align="absmiddle"> <input type="button" onclick="buyCredits(50);" value="Купить">
					</div>
				</li>
				<li>
					<div class="creditList">
						<span class="number">100</span> <img src="<?=RPATH ?>images/officiers/smalcredts.gif" alt="" align="absmiddle"> <input type="button" onclick="buyCredits(100);" value="Купить">
					</div>
				</li>
				<li>
					<div class="creditList">
						<span class="number">200</span> <img src="<?=RPATH ?>images/officiers/smalcredts.gif" alt="" align="absmiddle"> <input type="button" onclick="buyCredits(200);" value="Купить">
					</div>
				</li>
				<li>
					<div class="creditList">
						<span class="number">500</span> <img src="<?=RPATH ?>images/officiers/smalcredts.gif" alt="" align="absmiddle"> <input type="button" onclick="buyCredits(500);" value="Купить">
					</div>
				</li>
			</ul>
			<br>
...
<script type="text/javascript">
	function buyCredits(count)
	{
		...
		FAPI.UI.showPayment(count+' кредитов', 'Кредиты нужны для оплаты дополнительных услуг в игре.', 'credits', parseInt(count), null, '{"userId": <?=$userId ?>, "uni": <?=UNIVERSE ?>}', 'ok', true);
	}
