<? if (\Xcms\Core::getConfig('socialIframeView', 0) && $_SERVER['SERVER_NAME'] == 'ok1.xnova.su'): ?>
...
<div class="menu-sidebar visible-xs">
	<ul class="nav">
		<? foreach(_getText('main_menu') AS $id => $menu): if ($menu[2] > $adminlevel) continue; ?>
			<li><a data-link="<?=$id ?>" <? if (isset($menu[3])): ?>data-link="1"<? endif; ?> href="<?=$menu[1] ?>" <?=($set == $id ? 'class="check"' : '') ?>><?=$menu[0] ?></a></li>
		<? endforeach; ?>
	</ul>
</div>
<div class="contentBox set_<?=$set ?>">
	<div id="box">
		<div class="game_menu">
			<div class="visible-xs text-center bar">
				<? if (isset($tutorial) && $tutorial < 10): ?>
					<a class="m1 tooltip" href="?set=tutorial" data-tooltip-content="Квесты"><span class="sprite ico_tutorial"></span></a>
				<? endif; ?>
				<a class="m1 tooltip" href="?set=chat" data-tooltip-content="Чат"><span class="sprite ico_chat"></span></a>
				<a class="m1 tooltip" href="?set=messages" data-tooltip-content="Сообщения"><span class="sprite ico_mail"></span> <b><?=$mess ?></b></a>
				<? if ($mess_ally != ''): ?>
					<a class="m1 tooltip" href="?set=alliance&mode=circular" data-tooltip-content="Альянс"><span class="sprite ico_alliance"></span> <b><?=$mess_ally ?></b></a>
				<? endif; ?>
			</div>
			<div class="bar hhh hidden-xs">
				...
				<table align="center" class="top_menu">
					<tr>
						<? if (\Xcms\core::getConfig('socialIframeView', 0)): ?>
						...
						<? endif; ?>
						<? if (\Xcms\Core::getConfig('socialIframeView', 0) == 0): ?>
							<td class="m1"><a href="<?=\Xcms\Core::getConfig('forum_url', '') ?>" target="_blank" class="tooltip sprite ico_forum" data-tooltip-content="Форум"></a></td>
						<? endif; ?>
						...
						<? endif; ?>
						<? if (\Xcms\Core::getConfig('socialIframeView', 0) && $_SERVER['SERVER_NAME'] == 'ok1.xnova.su'): ?>
							<? if (!isset($_COOKIE[COOKIE_NAME.'_full'])): ?>
		...
		<div class="icon-panel visible-xs">
			<a href="?set=stat" class="sprite ico_stats"></a>
			<a href="?set=techtree" class="sprite ico_tech"></a>
			<a href="?set=sim" class="sprite ico_sim"></a>
			<a href="?set=search" class="sprite ico_search"></a>
			<a href="?set=support" class="sprite ico_support"></a>
			<a href="<?=\Xcms\Core::getConfig('forum_url', '') ?>" target="_blank" class="sprite ico_forum"></a>
			<a href="?set=options" class="sprite ico_settings"></a>
			<a href="?set=logout&popup" class="sprite ico_exit"></a>
		</div>
		<div class="game_content">
			...
			<? if (\Xcms\Core::getConfig('overviewListView', 0) == 1): ?>
