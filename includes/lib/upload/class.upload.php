    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
                $this->file_dst_name_body = utf8_encode(strtr(utf8_decode($this->file_dst_name_body), utf8_decode('Е ЕЅЕЎЕѕЕёГЂГЃГ‚ГѓГ„Г…Г‡Г€Г‰ГЉГ‹ГЊГЌГЋГЏГ‘Г’Г“Г”Г•Г–ГГ™ГљГ›ГњГќГ ГЎГўГЈГ¤ГҐГ§ГЁГ©ГЄГ«Г¬Г­Г®ГЇГ±ГІГіГґГµГ¶ГёГ№ГєГ»ГјГЅГї'), 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy'));
