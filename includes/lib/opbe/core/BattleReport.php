...
class BattleReport
{
	...
	public function getAttackersTech ()
	{
		...
		foreach ($players->getIterator() as $id => $player)
		{
			 ...
			 * @var Player $player
			 */
			$techs[$player->getId()] = array($player->getWeaponsTech(), $player->getShieldsTech(), $player->getArmourTech());
		}
	...
	{
		/**
		 * @var PlayerGroup $playersRepaired
		 */
